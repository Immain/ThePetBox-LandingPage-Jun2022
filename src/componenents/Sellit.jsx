    ...
    <div className='w-full bg-white py-16 px-4'>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
            <div className='flex flex-col justify-center'>
                ...
                <div className='justify-between space-x-1  items-center'>
                <button className='bg-[#0385b0] w-[200px] border-2 border-[#0385b0] hover:bg-blue-400 rounded-md font-medium my-6 mx-auto md:mx-0 py-2 px-2 text-black'>
                    View Plans
                </button>
